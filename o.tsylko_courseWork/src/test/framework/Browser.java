...
public final class Browser {
	private static final long IMPLICITY_WAIT = 30;
...
//	private static final String URL_LOGIN_PAGE = "urlLoginPage";
	...
	static final String DOWNLOAD_FILE = "fileName";
	static final String CURRENT_LANG = "language";
	static final String CURRENT_User = "userName";
	static final String PASSWORD = "userPassword";
	static final String EMAIL = "userEmail";
	static final String EMAIL_BODY = "emailBody";
	...
	private static void initProperties() {
	    ...
	    downloadPath = props.getProperty(DOWNLOAD_PATH);
	    fileName = props.getProperty(DOWNLOAD_FILE);
	    language = props.getProperty(CURRENT_LANG);
	    userName = props.getProperty(CURRENT_User);
	    userPassword = props.getProperty(PASSWORD);
	    userEmail = props.getProperty(EMAIL);
	    consumer = props.getProperty(CONSUMER);
	    emailBody = props.getProperty(EMAIL_BODY);
