...
public abstract class BaseElement extends BaseEntity {
	...
	public void waitForIsElementPresent() {
		...
		//Assert.assertTrue(formatLogMsg(getLoc("loc.is.absent")), element.isDisplayed()); for xUnit
		Assert.assertTrue(element.isDisplayed(),formatLogMsg(getLoc("loc.is.absent")));
	}
...
//ADDED by TSYLKO
	public void mouseHover(By loc){
		...
		WebElement element = browser.getDriver().findElement(loc);
